...
public class PrincipicLeggingsItem extends AbstractPrincipicArmor {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if(isEnabled(stack))
            tooltip.add(Util.tooltipStyle("tooltip.principium.principic_leggings.effect_enabled"));
        else
            tooltip.add(Util.tooltipStyle("tooltip.principium.principic_leggings.effect_disabled"));

        tooltip.add(Util.tooltipStyle("tooltip.principium.principic_leggings"));
        super.addInformation(stack, worldIn, tooltip, flagIn);
        tooltip.add(Util.loreStyle("lore.principium.principic_leggings"));
    }
